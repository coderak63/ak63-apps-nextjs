            ...
            <div class="grid sm:grid-cols-2 items-center gap-16 p-8 mx-auto max-w-4xl bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md text-[#333] font-[sans-serif]">
                        ...
                        <ul class="mt-3">
                            <li class="flex items-center">
                                ...
                                <a target="blank" href="https://veilmail.io/e/FkKh7o" class="text-[#007bff] text-sm ml-3">
                                    ...
                                    <strong>abhishek.mnnit.mca2k22@gmail.com</strong>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <form class="ml-auo space-y-4" onSubmit={onSubmit}>
                    <input type='text' placeholder='Name' name="name"
                        class="w-full rounded-md py-2.5 px-4 border text-sm outline-[#007bff]" required/>
                    <input type='email' placeholder='Email' name="email"
                        class="w-full rounded-md py-2.5 px-4 border text-sm outline-[#007bff]" required/>
                    
                    <textarea placeholder='Message' rows="6" name="message"
                        class="w-full rounded-md px-4 border text-sm pt-2.5 outline-[#007bff]" required></textarea>
                    <button type='submit'
